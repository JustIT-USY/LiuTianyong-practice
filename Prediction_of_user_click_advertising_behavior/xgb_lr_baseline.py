...
if __name__ == "__main__":
    ...
    xgb_enc.fit(model.apply(X_train))
    xgb_lm.fit(xgb_enc.transform(model.apply(X_train)), y_train)

    y_pred_xgb_lm = xgb_lm.predict_proba(xgb_enc.transform(model.apply(X_test)))[:, 1]
    ...
    # res_data.to_csv('result/submission_xgb_42F{}.csv'.format(score), index=False, encoding='utf-8')
